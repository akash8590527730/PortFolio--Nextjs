...
type BlogPostDocumentDataSlicesSlice = ImageBlockSlice | TextBlockkSlice;
...
type ProjectDocumentDataSlicesSlice = ImageBlockSlice | TextBlockkSlice;
...
interface SettingsDocumentData {
  ...
  /**
   * 0G Image field in *Settings*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.0g_image
   * - **Tab**: SEO and Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  "0g_image": prismic.ImageField<never>;
}
...
/**
 * Primary content in *TextBlockk → Default → Primary*
 */
export interface TextBlockkSliceDefaultPrimary {
  /**
   * Text field in *TextBlockk → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_blockk.default.primary.text
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
/**
 * Default variation for TextBlockk Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TextBlockkSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<TextBlockkSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *TextBlockk*
 */
type TextBlockkSliceVariation = TextBlockkSliceDefault;

/**
 * TextBlockk Shared Slice
 *
 * - **API ID**: `text_blockk`
 * - **Description**: TextBlockk
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TextBlockkSlice = prismic.SharedSlice<
  "text_blockk",
  TextBlockkSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TextBlockkSlice,
      TextBlockkSliceDefaultPrimary,
      TextBlockkSliceVariation,
      TextBlockkSliceDefault,
    };
  }
}
